...
<body>
    ...
    <div class="login-container">
        ...
        <div class="forgot-password">
            <p>Password Reset. Your password needs to be set.</p>
        </div>
        ...
        <form method="post" action="">
            ...
            <input type="text" name="email_or_id" placeholder="Email or ID Number" required value="<?php echo isset($_GET['identifier']) ? htmlspecialchars($_GET['identifier']) : (isset($_POST['email_or_id']) ? htmlspecialchars($_POST['email_or_id']) : ''); ?>" <?php echo isset($_GET['identifier']) ? 'readonly' : ''; ?>>
            ...
            <button type="submit" name="submit_newResetPass">Change Password</button>
