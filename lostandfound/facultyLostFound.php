...
<head>
    ...
    <title>Faculty Lost & Found</title>
...
<body>
    ...
    <nav class="nav">
        <ul>
            ...
            <li><a href="facultyLostFound.php" class="icon" style="color: #fff3b0; background-color: #8B1818;"><i class="fi fi-ss-grocery-basket"></i><span class="nav-text">Lost and Found</span></a></li>
        </ul>
    </nav>
    <main class="main">
