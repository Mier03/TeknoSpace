...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO posts (username, content, posttype,  profile_image, image_path, userId, status) VALUES ('$username', '$content','$posttype',  '$profile_image', '$imagePath', '$loggedUserId','lost')";
